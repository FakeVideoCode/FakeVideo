...
def create_mapping(map_name, mapping_path='src/pose/pretrains/mapper.txt',
                   part_info='src/pose/pretrains/smpl_part_info.json',
                   front_info='src/pose/pretrains/front_facial.json',
                   head_info='src/pose/pretrains/head.json',
...
def get_part_face_ids(part_type, mapping_path='src/pose/pretrains/mapper.txt',
                      part_info='src/pose/pretrains/smpl_part_info.json',
                      front_info='src/pose/pretrains/front_face_1.json',
                      head_info='src/pose/pretrains/head.json',
                      fill_back=False):
    # F x C
    f2vts = get_f2vts(mapping_path, fill_back=fill_back)
