...
def create_label(shape, joint_list, person_to_joint_assoc):
    ...
    for limb_type in range(17):
        for person_joint_info in person_to_joint_assoc:
            ...
            cord_list_end.append(joint_coords[len(joint_coords)//2])
    ...
    return label, cord_list, cord_list_end
...
def get_pose(param, heatmaps, pafs):
    ...
    # (Step 4): plot results
    label, cord_list, cord_list_end = create_label(shape, joint_list, person_to_joint_assoc)
