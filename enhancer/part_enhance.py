...
if __name__ == '__main__':
    ...
    lhand_dataset = dataset.FaceCropDataset(image_folder, lhand_pose_name, image_transforms, crop_size=crop_size)
    rhand_dataset = dataset.FaceCropDataset(image_folder, rhand_pose_name, image_transforms, crop_size=crop_size)
    lfoot_dataset = dataset.FaceCropDataset(image_folder, lfoot_pose_name, image_transforms, crop_size=crop_size)
    rfoot_dataset = dataset.FaceCropDataset(image_folder, rfoot_pose_name, image_transforms, crop_size=crop_size)
    ...
    for i in tqdm(range(length)):
        try:
            ...
            with torch.no_grad():
                ...
                lhand_residual = center_enhance(lhand_residual)
                ...
                rhand_residual = center_enhance(rhand_residual)
                ...
                lfoot_residual = center_enhance(lfoot_residual)
                ...
                rfoot_residual = center_enhance(rfoot_residual)
